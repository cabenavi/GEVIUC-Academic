...
public class LineUC{
	...
	public void InitUC(int[] ID, String[] Nombre, int[] BusIni, int[] BusFin, double[] Resistencia, double[] Reactancia, double[] Largo, double[] Voltaje, double[] Fmin, double[] Fmax, String[] Propietario, double[][] matriz_alpha) {
