...
public class DataLine extends DBObj{
	...
	void loaddatafromdatabase(String typedb, String namedb, String userdb, String passdb, int Tini_data, int Tfin_data,int object_id) throws Exception{  
		...
		//numero de tramos fijos (provisional)
		tramos_maximo=10;
		//base fija
		Sbase=100; 
		...
		matriz_alpha		= new double[tramos_maximo][Nh];
		...
		tramos_perdidas(Nh, tramos_maximo, matriz_alpha, Sbase, Fmax,Voltaje,Resistencia);
